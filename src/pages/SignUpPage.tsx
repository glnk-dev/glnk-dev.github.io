            ...
            <div className="bg-gray-50 rounded-xl p-4 mb-6 text-left">
              ...
              <ul className="text-sm text-gray-600 space-y-2">
                ...
                <li className="flex items-start gap-2">
                  ...
                  <span>You'll receive an email when your site is ready (usually within a few minutes)</span>
                </li>
              </ul>
            </div>
            <a
            ...
            {isAuthenticated && user && (
              <div className="flex items-center gap-3">
                {user.photoURL && (
                  <img
                    src={user.photoURL}
                    alt={githubLogin || user.displayName || 'User'}
          ...
          <div className="bg-white rounded-2xl shadow-lg border border-gray-200 p-8">
            <div className="text-center mb-8">
              ...
              <p className="text-gray-500 text-sm">
                Get your own personalized short link domain
              </p>
            </div>
                ...
                <div className="mb-6 space-y-3">
                  ...
                  <ul className="text-sm text-gray-600 space-y-2">
                    <li className="flex items-start gap-2">
                      ...
                      <span>Your own <span className="font-medium">{previewUrl}</span> domain</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <svg className="w-5 h-5 text-green-500 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                    ...
                    <li className="flex items-start gap-2">
                      ...
                      <span>Hosted on GitHub Pages — completely free</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <svg className="w-5 h-5 text-green-500 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                      </svg>
                      <span>Full control over your link configuration</span>
                    </li>
                  </ul>
                </div>
